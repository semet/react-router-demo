...
export const HeroSection = () => {
  return (
    <section className="relative">
      <div
        className="bg-primary/5 flex h-screen items-center justify-center bg-cover bg-center bg-no-repeat"
        style={{
      ...
      >
        <div className="container mx-auto max-w-[70%] space-y-4 text-center">
          ...
          <h2 className="text-primary text-xl font-bold md:text-2xl lg:text-4xl">
            Crafted with{' '}
            <motion.span
              animate={{
                scale: [1, 1.3, 1]
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              to="/dashboard"
              className="bg-info rounded-full px-6 py-3 text-white"
            >
              Look into Dashboard
            </Link>
            <Link
